suite('loadShader', function () {
  ...
  testSketchWithPromise(
    'error with vert prevents sketch continuing',
  ...
  testSketchWithPromise(
    'error with frag prevents sketch continuing',
    function (sketch, resolve, reject) {
      sketch.preload = function () {
  ...
  testSketchWithPromise(
    'error callback is called for vert',
    function (sketch, resolve, reject) {
      sketch.preload = function () {
        sketch.loadShader(
          invalidFile,
  ...
  testSketchWithPromise(
    'error callback is called for frag',
    function (sketch, resolve, reject) {
      sketch.preload = function () {
        sketch.loadShader(
          vertFile,
  ...
  testSketchWithPromise(
    'loading correctly triggers setup',
    function (sketch, resolve, reject) {
      sketch.preload = function () {
